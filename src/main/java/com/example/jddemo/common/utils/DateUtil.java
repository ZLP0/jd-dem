...
public class DateUtil {
     ...
     * @return
     */
    public static Long subtractDate(Date start, Date end) {
    ...
    public static long getDay(Long time) {
        long day = time / MILLISECOND_OF_DAY;
        return day;
    }
    ...
    public static long getHours(Long time) {
        long hours = time / MILLISECOND_OF_HOUR;
        return hours;
    }
    ...
    public static long getMinute(Long time) {
        long minute = time / MILLISECOND_OF_MINUTE;
        return minute;
    }
    ...
    public static long getSecond(Long time) {
        long second = time / MILLISECOND_OF_SECOND;
        return second;
    }
}
