...
import com.example.jddemo.nio.reactor.Handler;
...
public class MultiAcceptor implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            System.out.println(channel.getRemoteAddress()+"：得到一个客户端连接");
            channel.configureBlocking(false);
            channel.register(selector, SelectionKey.OP_READ,new MultiHandler(channel));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
